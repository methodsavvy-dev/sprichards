		...
		$postsArray[] = '
			<div class="related-post">
				...
				<div class="related-post__content">
					<div class="related-post__date">'. get_the_date() .'</div>
					<h2 class="related-post__title"><a href="'. get_the_permalink() .'">'. get_the_title() .'</a></h2>
					<div class="related-post__excerpt">'. get_the_excerpt() .'</div>
				</div>
			</div>
		';
	endwhile;
