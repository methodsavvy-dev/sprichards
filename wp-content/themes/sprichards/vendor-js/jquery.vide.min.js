...
! ( function( a, b ) {
	...
	'use strict'; function b( a ) {
		let b, c, d, e, f, g, h,
			i = {}; for ( f = a.replace( /\s*:\s*/g, ':' ).replace( /\s*,\s*/g, ',' ).split( ',' ), h = 0, g = f.length; h < g && ( c = f[ h ], c.search( /^(http|https|ftp):\/\// ) === -1 && c.search( ':' ) !== -1 ); h++ ) {
